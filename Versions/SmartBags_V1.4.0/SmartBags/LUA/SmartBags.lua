...
function SmartBags.Initialize( eventCode, addOnName )
	...
	SmartBags.CreateControls("SmartBagsUI")
...
function SmartBags.CreateVitualControls()
	--Icon
	SmartBags_Controls.SB_ModeIcon = WINDOW_MANAGER:CreateControl("SmartBagsUI_BankBagIcon", "SmartBagsUIBG", CT_TEXTURE)
	SmartBags_Controls.SB_ModeIcon:SetDimensions(24, 24)
	SmartBags_Controls.SB_ModeIcon:SetAnchor(TOPLEFT, "SmartBagsUIBG", TOPLEFT, 5, 5)
	
	--ProgressBar
	SmartBags_Controls.SB_ProgressBarMain = WINDOW_MANAGER:CreateControl("SmartBagsUI_Bag_ProgressBar", "SmartBagsUIProgressBar_Frame", CT_TEXTURE)
	SmartBags_Controls.SB_ProgressBarMain:SetTexture("SmartBags/Textures/ProgressBar_Gloss.dds")
	SmartBags_Controls.SB_ProgressBarMain:SetAnchor(TOPLEFT, "SmartBagsUIProgressBar_Frame", TOPLEFT, 4, 4)
	SmartBags_Controls.SB_ProgressBarRight = WINDOW_MANAGER:CreateControl("SmartBagsUI_Bag_ProgressBarRight", "SmartBagsUIBG", CT_TEXTURE)
	SmartBags_Controls.SB_ProgressBarRight:SetTexture("SmartBags/Textures/ProgressBarRight_Gloss.dds")
	SmartBags_Controls.SB_ProgressBarRight:SetDimensions(11, 11)
	SmartBags_Controls.SB_ProgressBarRight:SetAnchor(RIGHT, SmartBags_Controls.SB_ProgressBarMain, RIGHT, 11)
end
